...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">体操报名管理系统</a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li><a href="/adminIndex">主页</a></li>
                <li><a href="/studentManage">学生管理</a></li>
                <li><a href="/courseManage">项目管理</a></li>
                <li class="active"><a href="/SSchooseManage">报名管理</a></li>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/addChoose" method="post">
                        ...
                        <div class="form-group">
                            <label for="clzId">项目编号</label>
                            <input type="text" class="form-control" id="clzId" name="clzId" placeholder="项目编号" required>
                        </div>
